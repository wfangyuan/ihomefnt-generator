...
import generator.config.MongoManager;
import generator.entity.ColumnEntity;
import generator.entity.TableEntity;
import generator.entity.mongo.MongoDefinition;
import generator.entity.mongo.MongoGeneratorEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		mainPath = StringUtils.isBlank(mainPath) ? "generator" : mainPath;
		//封装模板数据
	...
	public static String getFileName(String template, String className, String packageName, String moduleName) {
		...
		if (template.contains("Repository.java.vm")) {
			return packagePath + "mapper" + File.separator + className + "Repository.java";
		}

		if (template.contains("RepositoryImpl.java.vm")) {
			return packagePath + "mapper" + File.separator + className + "RepositoryImpl.java";
		}
